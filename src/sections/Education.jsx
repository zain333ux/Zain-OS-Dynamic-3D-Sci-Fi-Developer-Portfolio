...
const Education = ({ isDeckView = false }) => {
  const content = (
    <div className={`max-w-4xl relative border-l border-cardBorder pl-6 md:pl-8 ml-3 space-y-10 ${isDeckView ? 'max-h-[55vh] overflow-y-auto pr-3 scrollbar-sleek py-2' : ''}`}>
